...
(function (window) {
	...
	function View(template) {
		...
		this.$loginButton = qs('#loginButton');
		this.$loginUserInput = qs('#loginUserInput');
		this.$loginPassInput = qs('#loginPassInput');
	}
	...
	View.prototype.bind = function (event, handler) {
        ...
        else if (event === 'loginButton') {
			$on(self.$loginButton, 'click', function (e) {
				e.preventDefault()
//				handler();
				handler(self.$loginUserInput.value, self.$loginPassInput.value);
			});
        }
	};
...
(function (window) {
	...
	function Controller(model, view) {
        ...
        // self.view.bind('loginButton', function () {
        self.view.bind('loginButton', function (user, pass) {
			// self.login();
